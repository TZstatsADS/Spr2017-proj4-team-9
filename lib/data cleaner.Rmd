...
```{r}
data.lib="/Users/limengchen/Desktop/Spr2017-proj4-team-9-master/data/nameset"
...
for (i in 1:length(query.list))
{
    ...
    write.csv(bigDataFrame, file = paste("/Users/limengchen/Desktop/Spr2017-proj4-team-9-master/data/nameset/", query.list[i], ".csv", sep=""))
}
