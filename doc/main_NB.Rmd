...
Please note to run "data cleaner.Rmd" first so that the .txt files are all in .csv format for processing.
...
```{r}
  ...
  ############################################################################
  for( i in 1:length(p_unseen.co))
  {
    if(p_unseen.co[i]==0)
    {
      p_unseen.co[i]=0.000001
    }
  }
